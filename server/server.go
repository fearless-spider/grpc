...
func getGData(data *gItem) *grpc.G {
	return &grpc.G{
		Id:          data.ID.Hex(),
		Pid:         data.Pid,
		Name:        data.Name,
...
func (*server) CreateG(ctx context.Context, req *grpc.CreateGRequest) (*grpc.CreateGResponse, error) {
...
func (*server) ReadG(ctx context.Context, req *grpc.ReadGRequest) (*grpc.ReadGResponse, error) {
...
func (*server) UpdateG(ctx context.Context, req *grpc.UpdateGRequest) (*grpc.UpdateGResponse, error) {
...
func (*server) DeleteG(ctx context.Context, req *grpc.DeleteGRequest) (*grpc.DeleteGResponse, error) {
...
func (*server) ListG(_ *grpc.ListGRequest, stream grpc.GService_ListGServer) error {
